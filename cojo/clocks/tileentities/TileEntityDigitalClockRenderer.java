...
public class TileEntityDigitalClockRenderer extends TileEntitySpecialRenderer {
	...
	private void renderDigitalClock(TileEntityDigitalClock clock, double par2, double par4, double par6, float par8) {
        ...
        if (f1 > 0.0F)
        {
            ...
            float f2 = (float)clock.getWorldObj().getTotalWorldTime() + par8;
